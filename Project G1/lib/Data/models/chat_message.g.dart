...
extension ChatMessageQueryWhere
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> textEqualTo(
      String text) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> textNotEqualTo(
      String text) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> isSyncedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isSynced',
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsSyncedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsSyncedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByIsSynced() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
